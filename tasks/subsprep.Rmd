...
Please ignore the `%>%` and whatever follows it in the code. It is used to avoid littering the the document with lenghty output.
...
Now you can see that there are 540 observations (`540 obs.`) that represent the rows of the data frame. As indicated by `10 variables`, the data frame has 10 variables, i.e. 10 columns. For each variable, you can see its name, type and some sample values it has.
